...
//This version attempts to add RTOS functionality for each task with out the timings or queue of previous versions//
...
//creation of defined tasks, here all set with the same priority
